  ...
  return (
    <section className="relative overflow-hidden min-h-[80vh] flex items-center justify-center px-6">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <img
          src="/src/assets/images/Landing Page Pond V3.png"
          alt=""
          aria-hidden
...
function NavCardsSection({ onNavigate }: { onNavigate: (s: ActiveSection) => void }) {
  return (
    <section className="relative bg-gold/15 py-20 md:py-28 px-6">
...
export default function TestPageV2b({ onNavigate }: Props) {
  return (
